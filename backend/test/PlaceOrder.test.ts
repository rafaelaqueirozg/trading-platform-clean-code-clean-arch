...
it("should not place a buy order without balance", async () => {
  const inputSignup = {
    name: "John Doe",
    email: "john.doe@gmail.com",
    document: "97456321558",
...
it("should not place a sell order without balance", async () => {
  const inputSignup = {
    name: "John Doe",
    email: "john.doe@gmail.com",
    document: "97456321558",
...
it("should place a buy order and a sell order", async () => {
  const marketId = `BTC-USD-${Math.random()}`;
...
it("should place a sell order and a buy order", async () => {
  const outputSignup = await signup.execute({
    name: "John Doe",
    email: "john.doe@gmail.com",
    document: "97456321558",
